    ...
    if (empty($checkPassowrds)) {
        try {
            ...
            if ($getUserData && password_verify($currentPassword, $getUserData->password)) {
                ...
                $_SESSION['successUpdatedPassword'] = "Your password is updated";
        ...
        <main class="flex flex-col justify-between gap-5 pt-7 m-7">
            ...
            <section class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div>
                        <?php if (isset($_SESSION["successUpdatedPassword"])): ?>
                            <p class=" successMessage hidden" data-success-updated-password="<?php echo $_SESSION["successUpdatedPassword"] ?>"></p>
                        <?php endif ?>
                        <?php
                        unset($_SESSION["successUpdatedPassword"]);
                        ?>
