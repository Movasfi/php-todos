...
<body>
    ...
    <div id="menu-container" class="w-full sm:hidden bg-navbar ">
        <ul class=" navbar-list flex-col p-4 space-y-3 transition-all duration-300 ease-in-out max-h-0 opacity-0 -translate-y-2 pointer-events-none">
            <li>
                <a href="../views/index.php" class="block font-medium hover:text-blue-500 transition-colors">Tasks</a>
            </li>
            <li>
                <a href="../views/overviewTodos.php" class="block font-medium hover:text-blue-500 transition-colors">Overview</a>
            </li>
